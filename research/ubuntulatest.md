...
**Source**: [Ubuntu 24.04 Runner Image Documentation](https://github.com/actions/runner-images/blob/releases/ubuntu24/20260329/images/ubuntu/Ubuntu2404-Readme.md)
...
> **Upcoming: Docker Server and Client will be updated to version 29.1.x, Docker Compose to 2.40.3** (image 20260329.72.1)
...
- **Kernel**: Linux 6.17.0-1008-azure
- **Architecture**: x86_64
...
### Package Managers
- **Homebrew**: 5.1.1 (installed at /home/linuxbrew, not in PATH by default)
- **Vcpkg**: Installed from commit b5d1a94fb7
- **Miniconda**: 26.1.1
...
- **Ubuntu 24.04 Documentation**: https://github.com/actions/runner-images/blob/releases/ubuntu24/20260329/images/ubuntu/Ubuntu2404-Readme.md
