...
describe("safe_outputs_config", () => {
  ...
  describe("loadConfig", () => {
    ...
    it("should use default output path when env var not set", () => {
      ...
      // Mock fs.mkdirSync to avoid permission error on /tmp/gh-aw/safeoutputs
      ...
      existsSyncSpy.mockImplementation(p => {
        // Pretend /tmp/gh-aw/safeoutputs exists to skip mkdir
        if (String(p).startsWith(`/tmp/gh-aw/safeoutputs`)) return true;
