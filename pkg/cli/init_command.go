...
To create, update or debug automated agentic workflows using GitHub, playwright, and other tools, load the .github/agents/agentic-workflows.agent.md (applies to .github/workflows/*.md)
