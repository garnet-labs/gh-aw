...
func (e *ClaudeEngine) GetExecutionSteps(workflowData *WorkflowData, logFile string) []GitHubActionStep {
	...
	// For GitHub Actions expressions, use the default value (expressions are evaluated at runtime)
	...
	// Supports both literal integers and GitHub Actions expressions
