...
`
	...
	if !strings.Contains(lockFile, "require((process.env.GH_AW_HOME || '/opt/gh-aw') + '/actions/push_repo_memory.cjs')") {
...
`
	...
	if !strings.Contains(lockFile, "bash ${GH_AW_HOME:-/opt/gh-aw}/actions/clone_repo_memory_branch.sh") {
